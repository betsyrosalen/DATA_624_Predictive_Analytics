...
```{r}
# freq.dist <- apply(Soybean, 2, table)
kable(summary(Soybean[,1:6])) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
kable(summary(Soybean[,7:12])) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
kable(summary(Soybean[,13:18])) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
kable(summary(Soybean[,19:24])) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
kable(summary(Soybean[,25:30])) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
kable(summary(Soybean[,31:36])) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```

```{r}
barplot(summary(Soybean$Class))
```
