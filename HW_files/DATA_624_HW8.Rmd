...
data.frame(rbind(knnTrainPR, knnTestPR))
```
...
data.frame(rbind(avNNetTrainPR, avNNetTestPR))
```
...
data.frame(rbind(marsTrainPR, marsTestPR))
```
...
data.frame(rbind(svmRTrainPR, svmRTestPR))
```
